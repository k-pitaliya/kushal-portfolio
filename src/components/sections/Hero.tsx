 ...
 * Hero — v2.
 *
 * Surgical minimum: name, role, one positioning sentence, two CTAs.
 *
 * NOTE: We deliberately do NOT use useScroll/useTransform here. Framer
 * Motion's scroll-driven hooks produce different output on server vs
 * client in this stack (React 19 + Next.js 16 + framer-motion 12),
 * which triggers hydration mismatches. Initial reveal uses opacity/y
 * transitions from an internal `ready` flag, which is hydration-safe.
 */
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center gap-8 text-center">
        ...
        <motion.h1
          ...
          style={{
            fontWeight: 800,
            background:
              "linear-gradient(180deg, var(--color-text) 0%, var(--color-text-muted) 130%)",
